              ...
              {generatedTrip.days.map((day, index) => (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      onClick={() =>
                        handleRegenerateDay(day.day_index || day.dayIndex || index + 1)
                      }
                      ...
                      <span className="font-medium text-black dark:text-white">
                        ...
                        {day.stops
                          .reduce((total, stop) => {
                            ...
                            return total + (parseFloat(String(cost)) || 0);
                          }, 0)
                          .toFixed(0)}
                      </span>
                    </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-[#1E1E1E] rounded-[24px] p-6 shadow-lg">
                ...
                <div className="space-y-3">
                  {generatedTrip.days.slice(0, 3).map((day, index) => (
                    <div
                      key={day.id || index}
                    ...
                    >
                      <span className="font-poppins text-sm text-black dark:text-white">
                        Day {day.day_index || day.dayIndex || index + 1}
                      </span>
                        ...
                        .reduce((total, day) => {
                          return (
                            ...
                            day.stops.reduce((dayTotal, stop) => {
                              ...
                              return dayTotal + (parseFloat(String(cost)) || 0);
                            }, 0)
                          );
                        }, 0)
                        .toFixed(0)}
